...
CREATE TABLE `dept_manager` (
  ...
  PRIMARY KEY (`dept_no`),
  KEY `emp_no` (`emp_no`),
  CONSTRAINT `dept_manager_ibfk_1` FOREIGN KEY (`emp_no`) REFERENCES `employees` (`emp_id`),
  CONSTRAINT `dept_manager_ibfk_2` FOREIGN KEY (`dept_no`) REFERENCES `deparments` (`dep_no`)
